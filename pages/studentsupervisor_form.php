...
<div class="container px-5 py-2">
    ...
    <div class=" card col-12 col-sm-8 col-md-6 col-lg-6 my-5">
      ...
      <div class="card-title text-center h3 p-3">
        ...
        <span>STUDENT SUPERVISOR FORM</span>
      </div>
      <form action="studentsupervisor_handler.php" method="POST" class="pb-3">
        <div class="col_12">
        <div class="row pt-3 pr-3 pl-3">
            <input type="number" class="form-control" name="stuID " id="stuID " placeholder="STUDENT  ID" required>
         </div>
         <div class="row pt-3 pr-3 pl-3">
             <input type="number" class="form-control" name="supID " id="supID " placeholder="SUPERVISOR ID" required>
         </div>
         <div class="row pt-3 pr-3 pl-3">
             <input type="number" class="form-control" name="userID " id="userID " placeholder="USER ID" required>
         </div>
