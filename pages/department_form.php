...
<div class="container px-5 py-2">
    ...
    <div class=" card col-12 col-sm-8 col-md-6 col-lg-6 my-5">
      ...
      <form action="department_handler.php" method="POST" class="pb-3">
        <div class="col_12">
        <div class="row pt-3 pr-3 pl-3">
            <input type="text" class="form-control" name="DepName" id="DepName" placeholder="DEPARTMENT NAME" required>
         </div>
         <div class="row pt-3 pr-3 pl-3">
